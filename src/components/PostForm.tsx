...
import { CATEGORIES, CategoryType, PostProps } from "./PostBoxList";
...
export default function PostForm() {
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            if (post && post.id) { // 만약 post 데이터가 있다면, firestore로 데이터 수정
            ...
            } else { // firestore로 데이터 생성 - 자동 ID 생성
